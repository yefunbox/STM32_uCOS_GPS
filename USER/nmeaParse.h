...
typedef struct
{
    ...
    u16 Speed;          // ÈÄüÁéá000.0~999.9ËäÇ  x10
    char sSpeed[5];     // DEBUG
    u16 Course;         // Ëà™Âêë000.0~359.9Â∫¶  x10
...
typedef struct
{
    ...
    u8 SatUsedList[12];	// ‰ΩøÁî®‰∏≠ÁöÑÂç´ÊòüÂè∑
    char PDOP[5];       // ‰ΩçÁΩÆÁ≤æÂ∫¶ 0.5-99.9
    char HDOP[5];       // Ê∞¥Âπ≥Á≤æÂ∫¶ 0.5-99.9
    char VDOP[5];       // ÂûÇÁõ¥Á≤æÂ∫¶ 0.5-99.9
}struct_GPSGSA;

typedef struct
{
    u8 SatID;           // Âç´ÊòüÂè∑
    u8 Elevation;       // Âç´Êòü‰ª∞Ëßí   00-90 Â∫¶
    u16 Azimuth;        // Âç´ÊòüÊñπ‰ΩçËßí 000-359 Â∫¶
    u8 SNR;             // ËÆØÂè∑Âô™Â£∞ÊØî 00-99 dbHz
}struct_SatInfo;
...
#define NMEA_NULL   0x00        //GPSËØ≠Âè•Á±ªÂûã
...
enum nmeaPACKTYPE
{
	...
	GPGLL   = 0x2000,   //Geographic Position£®GLL£©∂®Œªµÿ¿Ì–≈œ¢

    GPTXT   = 0x0020,   /**< TXT - ≤˙∆∑–≈œ¢°¢ÃÏœﬂ◊¥Ã¨°¢»Ú√Îµ» */

    BDGSV   = 0x0040,   /**< GSV - ø…º˚Œ¿–« */
    BDGSA   = 0x0080,   /**< GGA - æ´∂»“Ú◊”∫Õ”––ßŒ¿–« */

    GNZDA   = 0x0100,   /**< ZDA -  ±º‰∫Õ»’∆⁄ */
    GNGLL   = 0x0200,   /**< GLL - µÿ¿ÌŒª÷√ æ≠Œ≥∂» */
    GNVTG   = 0x0400,    /**< VTG - ∂‘µÿÀŸ∂»∫Õ∫ΩœÚ */
    GNRMC   = 0x0800,   /**< RMC - Õ∆ºˆµƒ◊Ó…Ÿ◊®”√∫ΩœÚ ˝æ› */
    GNGGA   = 0x1000,   /**< GGA - Ω” ’ª˙∂®Œª ˝æ›£¨œÍœ∏*/
};
...
typedef struct _nmeaINFO
{
    ...
    double  sog;        /**<  ˝÷µ ∂‘µÿÀŸ∂»£¨µ•ŒªŒ™Ω⁄ */
    double  speed;      /**< Speed over the ground in kilometers/hour */
    double  direction;  /**< Track angle in degrees True */
    double  declination; /**< Magnetic variation degrees (Easterly var. subtracts from true course) */
    char    mode;       /**< ◊÷∑˚ ∂®Œªƒ£ Ω±Í÷æ (A = ◊‘÷˜ƒ£ Ω, D = ≤Ó∑÷ƒ£ Ω, E = π¿À„ƒ£ Ω, N =  ˝æ›Œﬁ–ß) */
    nmeaSATINFO satinfo; /**< Satellites information */
    nmeaSATINFO BDsatinfo; /**±±∂∑Œ¿–«–≈œ¢*/
